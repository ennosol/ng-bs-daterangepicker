describe('the daterange directive', function() {
	...
	beforeEach(module('nslBootstrapDaterangepicker'));
	...
	it('creates an instance of daterangepicker', function() {
		var element = $ngCompile('<input type="text" nsl-bootstrap-daterangepicker ng-model="dummy">')($ngRootScope);
	...
	it('creates an instance with provided values', function() {
		...
		var normalized = 'YYYY-MM-DD',
			...
			limitAmount = 1,
			limitUnit = 'week',
			element = $ngCompile('<input nsl-bootstrap-daterangepicker type="text" ng-model="dates" format="' + format + '" separator="' + separator + '" min-date="' + minDate + '" max-date="' + maxDate + '" limit="' + limitAmount + ' ' + limitUnit + '">')($ngRootScope);
	...
	it('passes on ranges from scope to daterangepicker instance', function() {
		...
		var element = $ngCompile('<input nsl-bootstrap-daterangepicker type="text" ng-model="dummy" ranges="ranges">')($ngRootScope);
	...
	it('passes opens option from attributes to daterangepicker instance', function() {
		var element = $ngCompile('<input nsl-bootstrap-daterangepicker type="text" ng-model="dummy" opens="left">')($ngRootScope);
